...
class Ced_Walmart_Insights {
	...
	public function ced_walmart_pro_seller_badge_data() {
		...
		$pro_seller_badge_data = get_option( 'ced_walmart_pro_seller_badge_details' );
	...
	public function ced_walmart_overall_listing_quality_data() {
		...
		$listing_quality_data = get_option( 'ced_walmart_overall_listing_quality_details' );
	...
	public function ced_walmart_unpublished_counts() {
		$unpublished_item_count_data = get_option( 'ced_walmart_unpublished_items_counts' );
