...
class Ced_Walmart_Order {
	...
	public function create_local_order( $orders ) {
		if ( is_array( $orders ) && ! empty( $orders ) ) {
			...
			foreach ( $orders as $order_detail ) {
				...
				$order_id = $this->create_order( $address, $order_items_info, 'Walmart', $walmart_order_meta );
	 ...
	 */
	public function create_order( $address = array(), $order_items_info = array(), $marketplace = 'Walmart', $order_meta = array() ) {
		$order_id      = '';
		$order_created = false;
