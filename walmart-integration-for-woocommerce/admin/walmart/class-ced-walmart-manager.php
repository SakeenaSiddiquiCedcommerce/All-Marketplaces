...
class Ced_Walmart_Manager {
	 ...
	 * @since 1.0.0
	 */
	public function ced_walmart_refresh_token() {
		if ( ! get_transient( 'ced_walmart_token_transient' ) ) {
	 ...
	 */
	public function ced_walmart_upload( $walmart_product_ids = array(), $process_mode = 'CREATE' ) {
		$response = $this->ced_walmart_product_manager->ced_walmart_prepare_data( $walmart_product_ids, $process_mode );
		if ( $response ) {
			$filepath = $response;
			$response = $this->ced_walmart_product_manager->ced_walmart_upload( $filepath );
		}
		return $response;
	}
	 ...
	 * @param array $walmart_product_ids.
	 */
	public function ced_walmart_update_price( $walmart_product_ids = array() ) {
		$response = $this->ced_walmart_product_manager->ced_walmart_prepare_price_data( $walmart_product_ids );
		if ( $response ) {
			$filepath = $response;
			$response = $this->ced_walmart_product_manager->ced_walmart_upload( $filepath, 'price' );
		}
		return $response;
	}
	 ...
	 * @param array $walmart_product_ids.
	 */
	public function ced_walmart_update_stock( $walmart_product_ids = array() ) {
		$response = $this->ced_walmart_product_manager->ced_walmart_prepare_stock_data( $walmart_product_ids );
		if ( $response ) {
			$filepath = $response;
			$response = $this->ced_walmart_product_manager->ced_walmart_upload( $filepath, 'inventory' );
		}
		return $response;
	}
	 ...
	 * @param array $walmart_product_ids.
	 */
	public function ced_walmart_update_shipping_template( $walmart_product_ids = array(), $action = 'Add' ) {
		$response = $this->ced_walmart_product_manager->ced_walmart_prepare_shipping_template_data( $walmart_product_ids, $action );
		if ( $response ) {
			$filepath = $response;
			$response = $this->ced_walmart_product_manager->ced_walmart_upload( $filepath, 'SKU_TEMPLATE_MAP' );
		}
		return $response;
	}
	...
	public function ced_walmart_retire_items( $walmart_product_ids = array() ) {
