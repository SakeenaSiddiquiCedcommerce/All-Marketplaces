			...
			<div>
				<div class="ced_walmart_heading">
					...
					<div class="ced_walmart_child_element default_modal">
						<ul type="disc">
							<li><?php echo esc_html_e( 'In this section you can view all the feeds uploaded and their status' ); ?></li>
						</ul>
					</div>
				</div>
	...
	public function process_bulk_action() {
		if ( ( isset( $_POST['action'] ) && 'delete' == $_POST['action'] ) || ( isset( $_POST['action2'] ) && 'delete' == $_POST['action2'] ) ) {
			...
			if ( ! empty( $ced_walmart_import_ids_to_be_deleted ) && is_array( $ced_walmart_import_ids_to_be_deleted ) ) {
				...
				$redirect_url = get_admin_url() . 'admin.php?page=ced_walmart&section=feeds';
