	...
	<div id="ced_walmart_order_settings" class="panel woocommerce_options_panel ced_walmart_section_wrapper">
		...
		<div class="options_group umb_walmart_options"> 
			...
			if ( 'Created' == $ced_walmart_order_status ) {
				...
				?>
				<input type="button" class="button-primary" value="Cancel Order" data-order_id = "<?php echo esc_attr( $order_id ); ?>" id="ced_walmart_cancel_action"/>
				...
				<table class=" widefat fixed striped">
					...
					<input data-items="<?php echo esc_attr( $number_items ); ?>" type="button" class="button-primary" id="ced_walmart_shipment_submit" value="Submit Shipment">
					<?php
							...
							foreach ( $order_items as $k => $valdata ) {
								...
								?>
									...
									<?php if ( $avail_qty > 0 ) : ?>
											...
											<!-- Rma input -->
											<td>
												<?php echo esc_attr( $walmart_rma ); ?>
											</td>
											<td>
												<?php echo esc_attr( $walmart_days_to_return ); ?>
											</td>
										</tr>
										<?php
							}
