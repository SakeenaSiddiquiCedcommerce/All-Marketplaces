...
class Walmart_Woocommerce_Integration {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-walmart-woocommerce-integration-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-walmart-woocommerce-integration-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-walmart-woocommerce-integration-admin.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'ced_add_marketplace_menus_array', $plugin_admin, 'ced_walmart_add_marketplace_menus_to_array', 13 );
		...
		$this->loader->add_action( 'wp_ajax_ced_walmart_process_api_keys', $plugin_admin, 'ced_walmart_process_api_keys' );
		...
		$this->loader->add_action( 'ced_walmart_auto_fetch_orders', $plugin_admin, 'ced_walmart_auto_fetch_orders' );
		...
		$this->loader->add_action( 'wp_ajax_ced_walmart_save_cat_for_wfs', $plugin_admin, 'ced_walmart_save_cat_for_wfs' );
		$this->loader->add_action( 'wp_ajax_ced_walmart_save_subcat_for_wfs', $plugin_admin, 'ced_walmart_save_subcat_for_wfs' );
		$this->loader->add_action( 'wp_ajax_ced_walmart_save_cat_for_new_item_wfs', $plugin_admin, 'ced_walmart_save_cat_for_new_item_wfs' );
		$this->loader->add_action( 'wp_ajax_ced_walmart_save_subcat_for_new_item_wfs', $plugin_admin, 'ced_walmart_save_subcat_for_new_item_wfs' );
