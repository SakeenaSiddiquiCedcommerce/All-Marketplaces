			...
			<div class="ced_fmcw_facebook_collapse">
				<div class="options_group ced_fmcw_facebook_label_data">
					<p class="form-field ced_fmcw_availability_field ">
						...
						<?php $ced_fmcw_availability = get_post_meta( $product_post->ID, 'ced_fmcw_availability_', true ); ?>
						<label><span><?php esc_attr_e( 'Availability', 'facebook-marketplace-connector-for-woocommerce' ); ?></span></label>
						<select name="ced_fmcw_availability_[<?php echo esc_attr( $variation->ID ); ?>]" id="ced_fmcw_availability" class="ced_fmcw_data_fields">
					...
					<?php $ced_fmcw_condition = get_post_meta( $product_post->ID, 'ced_fmcw_condition_', true ); ?>
					<p class="ced_fmcw_condition_field form-field">
						...
						<select name="ced_fmcw_condition_[<?php echo esc_attr( $variation->ID ); ?>]" id="ced_fmcw_condition" class="ced_fmcw_data_fields">
					...
					<?php $ced_fmcw_agegrp = ''; ?>
					<?php $ced_fmcw_agegrp = get_post_meta( $product_post->ID, 'ced_fmcw_agegrp_', true ); ?>
					<p class="ced_fmcw_agegrp_field form-field">
						...
						<select name="ced_fmcw_agegrp_[<?php echo esc_attr( $variation->ID ); ?>]" id="ced_fmcw_agegrp" class="ced_fmcw_data_fields">
							<option value=""><?php esc_attr_e( '--Select--', 'facebook-marketplace-connector-for-woocommerce' ); ?></option>
					...
					<?php $ced_fmcw_gender = ''; ?>
					<?php $ced_fmcw_gender = get_post_meta( $product_post->ID, 'ced_fmcw_gender_', true ); ?>
					<p class="ced_fmcw_gender_field form-field">
						...
						<select name="ced_fmcw_gender_[<?php echo esc_attr( $variation->ID ); ?>]" id="ced_fmcw_gender" class="ced_fmcw_data_fields">
							<option value=""><?php esc_attr_e( '--Select--', 'facebook-marketplace-connector-for-woocommerce' ); ?></option>
							<option value="male" 
							<?php
					...
					<?php $ced_fmcw_brand = ''; ?>
					<?php $ced_fmcw_brand = get_post_meta( $product_post->ID, 'ced_fmcw_brand_', true ); ?>
					<p class="ced_fmcw_color_field form-field">
						...
						<input type="text" class="ced_fmcw_data_fields" id="ced_fmcw_brand" name="ced_fmcw_brand_[<?php echo esc_attr( $variation->ID ); ?>]" value="<?php echo esc_attr( $ced_fmcw_brand ); ?>"></input>
					</p>
					<?php $ced_fmcw_mpn = ''; ?>
					<?php $ced_fmcw_mpn = get_post_meta( $product_post->ID, 'ced_fmcw_mpn_', true ); ?>
					<p class="ced_fmcw_material_field form-field">
						...
						<input type="text" class="ced_fmcw_data_fields" id="ced_fmcw_mpn" name="ced_fmcw_mpn_[<?php echo esc_attr( $variation->ID ); ?>]" value="<?php echo esc_attr( $ced_fmcw_mpn ); ?>"></input>
					</p>
					<?php $ced_fmcw_gtin = ''; ?>
					<?php $ced_fmcw_gtin = get_post_meta( $product_post->ID, 'ced_fmcw_gtin_', true ); ?>
					<p class="ced_fmcw_material_field form-field">
						<label><span><?php esc_attr_e( 'GTIN', 'facebook-marketplace-connector-for-woocommerce' ); ?></span></label>
						<input type="text" class="ced_fmcw_data_fields" id="ced_fmcw_gtin" name="ced_fmcw_gtin_[<?php echo esc_attr( $variation->ID ); ?>]" value="<?php echo esc_attr( $ced_fmcw_gtin ); ?>"></input>
					</p>
					<?php
